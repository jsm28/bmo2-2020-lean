...
begin
  ...
  { intros i j hi hj heq,
    ...
    rw [fin.eq_iff_veq, of_nat_val hai, of_nat_val haj, add_left_cancel_iff] at heq1,
    rw [fin.eq_iff_veq, of_nat_val hbi, of_nat_val hbj, add_left_cancel_iff] at heq2,
...
begin
  ...
  { apply fin.eq_of_veq,
    unfold fin.val,
    exact of_nat_val (show a_val + 1 < 2019, by linarith only [ha]) },
  have hbo : fin.of_nat (b_val + 1) = ⟨b_val + 1, hbo1⟩,
  { apply fin.eq_of_veq,
    unfold fin.val,
    exact of_nat_val (show b_val + 1 < 2019, by linarith only [hb]) },
  ...
  { conv
    ...
    { ext,
      ...
      { intro h,
        ...
        rw [of_nat_val hao1, of_nat_val hbo1] at h1,
        repeat { cases h1 },
...
begin
  ...
  { by_cases h : b.val < m,
    { rw nat.succ_eq_add_one at hb2a,
      ...
      { rw of_nat_coe (show m < 2019, by linarith),
        linarith },
      convert rows_alternate_two_cols c hbal2 a (fin.of_nat m) ha hb2ax,
      { exact (of_nat_coe (show m < 2019, by linarith)).symm },
      { exact (of_nat_coe (show m < 2019, by linarith)).symm } },
...
begin
  ...
  { rw ←not_iff_not,
    ...
    have hf : ((fin.of_nat k : fin 2019) : ℕ) = k :=
      of_nat_coe (show k < 2019, by linarith only [ha]),
  ...
  { unfold subcolouring,
    ...
    { intro hm,
      ...
      { rcases hm with ⟨ha1, hb1, ha2, hb2⟩,
        ...
        { exact hmc },
        { rw fin.le_iff_val_le_val at ha1,
          rw [of_nat_val h, fin.coe_eq_val] at ha1,
          rw fin.le_iff_val_le_val,
          linarith },
        { exact hb1 },
        { convert ha2 using 1,
          rw [of_nat_coe h, add_assoc] },
        { exact hb2 } } },
    { intro hm,
      ...
      { by_cases hx : (x.fst : ℕ) < (a : ℕ) + k1_1,
        ...
        { right,
          rw [fin.le_iff_val_le_val, of_nat_val h, of_nat_coe h],
          repeat { split },
          { exact not_lt.mp hx },
          { exact hb1 },
          { convert ha2 using 1,
...
begin
  ...
  { intros i hi,
    ...
    rw [fin.le_iff_val_le_val, of_nat_val hai, of_nat_coe hai],
    repeat { split },
    { exact mem_univ _ },
    { rw fin.coe_eq_val,
      linarith },
  ...
  { intros i j hi hj,
    ...
    rw [of_nat_val hai, of_nat_val haj],
    intro hij,
...
begin
  ...
  { repeat { rw fin.coe_eq_val },
    rw fin.coe_eq_val at ha,
    exact of_nat_val (show a.val + 1 < 2019, by linarith) },
    ...
    { intro hm,
      ...
      { repeat { split },
        ...
        { cases hm with hm1 hm2,
          rw [fin.le_iff_val_le_val, of_nat_val h, fin.coe_eq_val] at hm1,
          rw fin.le_iff_val_le_val,
          linarith },
        { cases hm with hm1 hm2,
          rw [of_nat_coe h, add_assoc] at hm2,
          exact hm2 } } },
    { intro hm,
      ...
      { by_cases hx : (x : ℕ) < (a : ℕ) + k2_1,
        ...
        { right,
          rw not_lt at hx,
          split,
          { rw [fin.le_iff_val_le_val, of_nat_val h, fin.coe_eq_val],
  ...
  { convert card_empty,
    ...
    { ext,
      ...
      { intro hx,
        ...
        rw fin.coe_eq_val at *,
        rw fin.coe_eq_val at *,
        rw [fin.le_iff_val_le_val, of_nat_val h] at ha3,
        linarith },
      { exact false.elim } },
    { exact classical.dec_pred _ } }
end
...
begin
  ...
  { have hk2pos : 0 < k2 := nat.pos_of_ne_zero h0,
    ...
    rw [add_assoc, add_comm (2 * k2) 1, ←add_assoc, ←of_nat_coe hk2a] at hk2,
...
begin
  ...
  { rw [hnalt1, ←hnalt2, (show (a : ℕ) + 2 * k2 + 1 = (a : ℕ) + 1 + 2 * k2, by ring)],
    ...
    all_goals { try { rw of_nat_coe hs2 } },
    { simp },
    { linarith },
  ...
  { by_cases hnalt : ∃ k : ℕ, 0 < k ∧ k < 2 * (nat.succ k2a) + 1 ∧
    ...
    { rcases hnalt with ⟨k, hk0, hk1, halt⟩,
      ...
      { set k3 := k / 2 with hk3,
        ...
        { rw [ha2, of_nat_coe ha2a,
              (show (a : ℕ) + 2 * k3 + 2 * k4 = (a : ℕ) + 2 * (k4 + k3), by ring), hk4c],
          exact hk2 },
        rw [←hk3a, ←ha2, ←of_nat_coe ha2a, ←ha2] at halt,
...
begin
  ...
  { set k2 := (a2 - a1) / 2 with hk2,
    use fin.of_nat a1,
    use k2,
    rw of_nat_coe (show a1 < 2019, by linarith),
  ...
  { set k2 := (a1 - a2) / 2 with hk2,
    use fin.of_nat a2,
    use k2,
    rw of_nat_coe (show a2 < 2019, by linarith),
...
begin
  ...
  { intro h,
    ...
    { intros k hk hpar,
      ...
      { rw ha,
        symmetry,
        exact of_nat_coe (show k < 2019, by linarith only [hk]) },
      rw hk2,
      rw hk2 at hk,
      exact h a hk },
    { intros k hk hpar,
...
begin
  ...
  { intro h,
    ...
    intros k hk hpar,
    erw [mem_filter, mem_filter],
    rw [of_nat_coe (show k < 2019, by linarith),
        of_nat_coe (show k + 1 < 2019, by linarith)],
    ...
    { intro k,
      ...
      { intro hst,
        ...
        rw [iff_true_intro (mem_univ _), true_and,
            of_nat_coe (show t < 2019, by linarith only [hst])] at ht,
...
begin
  ...
  { have ha : (fin.of_nat (2 * a - 1) ∈ map_to_alt_colouring x ↔
    ...
    { rw [of_nat_coe (show 2 * b + 1 < 2019, by linarith only [hble]),
          of_nat_coe (show 2 * b + 1 + 1 < 2019, by linarith only [hble])] at ha,
...
begin
  ...
  { intro hc1,
    ...
    { unfold row_alt_colourings_1 at hc1,
      ...
      { intros k hk hpar,
        unfold reverse_row_colouring,
        erw [mem_filter, mem_filter],
        rw [of_nat_coe (show k < 2019, by linarith only [hk]),
            of_nat_coe (show k + 1 < 2019, by linarith only [hk]),
  ...
  { intro hc0,
    ...
    { intros k hk hpar,
      ...
      erw [mem_filter, mem_filter],
      rw [of_nat_coe (show k < 2019, by linarith only [hk]),
          of_nat_coe (show k + 1 < 2019, by linarith only [hk]), add_comm k 1,
...
begin
  ...
  { intros k2 hk2,
    ...
    { exact (of_nat_coe (show k2 < 2019, by linarith)).symm },
    { rw of_nat_coe (show k2 < 2019, by linarith),
      linarith } },
  { rw hk,
    exact a.is_lt }
end
  ...
  { intros i hi,
    ...
    { intros a ha,
      ...
      { intro h,
        ...
        rw of_nat_coe (show (a : ℕ) + 1 < 2019, by linarith only [ha]) at ha1i,
        rw ←hai at ha1i,
      ...
      { intro h,
        ...
        use mem_univ _,
        rw of_nat_coe (show (a : ℕ) + 1 < 2019, by linarith only [ha]) at h,
        by_cases hpar : i % 2 = 0,
